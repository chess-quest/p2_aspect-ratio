...
class TestFormula(unittest.TestCase):
    ...
    # Tests the function width_from_height when given whole numbers, strings, and floats
    ...
    # Tests the function height_from_width when given whole numbers, strings, and floats
